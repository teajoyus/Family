...
public void addFamily(View view){
    ...
    private void setTabSelection(int index) {
        ...
        switch (index) {
            ...
            case 1:
                ...
                secondImage.setImageResource(R.drawable.message_selected);
            ...
            case 2:
                ...
                thridImage.setImageResource(R.drawable.discovery_selected);
            ...
            default:
                ...
                if (fragmentFourth == null) {
                    ...
                    fragmentFourth = new MainFragment();
    ...
    private void clearSelection() {
        ...
        secondImage.setImageResource(R.drawable.message_unselected);
        secondText.setTextColor(0xc0000000);
        thridImage.setImageResource(R.drawable.discovery_unselected);
